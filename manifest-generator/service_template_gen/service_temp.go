...
func main() {
	...
	var public_ip = flag.String("PUBLIC_IP", 1, "Public IP for the service.")

	flag.Parse()

	args := []string{*service_name, *app_name, *env, *service_type, *app_group, strconv.Itoa(*container_port), strconv.Itoa(*build_number), *public_ip}
